...
export function ContactForm({ locale, profile }: ContactFormProps) {
            ...
            <div className="bg-secondary-50 dark:bg-secondary-900 rounded-2xl border border-secondary-100 dark:border-secondary-800 p-8">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-secondary-500 dark:text-secondary-400">{t('contact.email')}</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-secondary-500 dark:text-secondary-400">{t('contact.phone')}</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-secondary-500 dark:text-secondary-400">{t('contact.linkedin')}</p>
                    <p className="font-medium text-secondary-900 dark:text-white">{t('contact.linkedinDesc')}</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm text-secondary-500 dark:text-secondary-400">{t('contact.github')}</p>
                    <p className="font-medium text-secondary-900 dark:text-white">{t('contact.githubDesc')}</p>
                  </div>
                </a>
              </div>
            </div>
